...
export function ExplorationCard({ technology }: ExplorationCardProps) {
  ...
  return (
    ...
    >
      ...
      <h3 className="mb-2 text-[18px] font-semibold uppercase tracking-widest text-text-primary-light dark:text-text-primary-dark">
        {technology.title}
      </h3>

      <p className="mb-4 text-[16px] leading-relaxed text-text-secondary-light dark:text-text-secondary-dark">
